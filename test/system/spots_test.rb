...
class SpotsTest < ApplicationSystemTestCase
  ...
  test "creating a Spot" do
    ...
    fill_in "Prefecture", with: @spot.prefecture
    fill_in "Season", with: @spot.season
    fill_in "Spot address", with: @spot.spot_address
    fill_in "Spot image", with: @spot.spot_image_id
    fill_in "Spot name", with: @spot.spot_name
